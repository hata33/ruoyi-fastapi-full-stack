...
flowchart LR
    ...
    classDef stage0 fill:#DBEAFE,stroke:#3B82F6,stroke-width:2px,color:#1e3a8a
    classDef stage1 fill:#D1FAE5,stroke:#10B981,stroke-width:2px,color:#065f46
    classDef stage2 fill:#FEF3C7,stroke:#F59E0B,stroke-width:2px,color:#92400e
    classDef stage3 fill:#EDE9FE,stroke:#8B5CF6,stroke-width:2px,color:#5b21b6
    classDef stage4 fill:#FEE2E2,stroke:#EF4444,stroke-width:2px,color:#991b1b

    class A,C,D,G stage0
    class B,E,F,H stage1
    class I,J,K,L stage2
    class M,N,O,P stage3
    class Q,R,S stage4
```
