...
**最终 URL**：
```
GET  /api/user/list   → userController.get_user_list()
GET  /api/role/list   → roleController.get_role_list()
GET  /api/dept/list   → deptController.get_dept_list()
```
