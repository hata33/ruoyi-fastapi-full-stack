...
class ChatMessageDao:
    ...
    @classmethod
    async def get_message_by_id(cls, db: AsyncSession, message_id: int):
        """
        根据消息id获取消息详细信息
    ...
    async def get_message_list_by_conversation(
        cls, db: AsyncSession, conversation_id: int, before_message_id: int = None, page_size: int = 50
    ):
        """
        获取会话的消息列表
    ...
    @classmethod
    async def get_conversation_messages(cls, db: AsyncSession, conversation_id: int):
        """
        获取会话的所有消息
    ...
    @classmethod
    async def get_recent_messages(cls, db: AsyncSession, conversation_id: int, limit: int = 50):
        """
    ...
    @classmethod
    async def update_message_tokens(cls, db: AsyncSession, message_id: int, tokens_used: int):
        """
        更新消息token数
    ...
    @classmethod
    async def delete_conversation_messages(cls, db: AsyncSession, conversation_id: int):
        """
        删除会话的所有消息
    ...
    @classmethod
    async def count_messages_by_conversation(cls, db: AsyncSession, conversation_id: int):
        """
        统计会话消息数量
    ...
    @classmethod
    async def get_last_message_by_conversation(cls, db: AsyncSession, conversation_id: int):
        """
        获取会话的最后一条消息
